...
namespace SQL_Lib
{
    interface iQuery
    {
        void Add(int Tour_Code, string Company_Information, DateTime Tour_Start_Date, DateTime Tour_End_Date, int Number_Of_Passengers, int Number_Of_Tour_Guides, int Number_Of_Buses);
